...
<head>
    ...
    <title>Práctica 6 - Ejercicios</title>
...
<body class="bg-gray-200 flex flex-col min-h-screen">
    <header class="bg-blue-950 text-white py-5 shadow-md static">
        <div class="container mx-auto text-center py-2">
            <h1 class="text-3xl font-bold">Práctica 6</h1>
            <p class="text-sm mt-2">Programación Orientada a Objetos en PHP</p>
        </div>
    ...
    <main class="flex-grow container mx-auto my-8 px-4">
        <section class="bg-white shadow-md rounded-lg p-6">
            ...
            <ul class="space-y-4">                                                 
                ...
                <li>
                    <a href="Discusion2/" class="block bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg p-4 text-blue-950">
                        Discusión 2
                    </a>
                </li>                                                   
            </ul>
    ...
    <footer class="bg-gray-800 text-white py-4 mt-auto w-full">
        ...
        <p>&copy; <?php echo date("Y"); ?> Práctica 6 - <a class="hover:underline" href="https://github.com/DiegoMajano/">Diego José Rodríguez Majano</a></p>
        </div>
    </footer>
</body>
</html>