    ...
    <main class="flex-grow container mx-auto mt-8 px-4 h-100">
        <section class="bg-white shadow-md rounded-lg p-6">
            ...
            <ul class="space-y-4">
                ...
                <li>
                    <a href="Practica3/" class="block bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg p-4 text-blue-950">
                        Práctica 3: Arreglos y matrices en PHP
                    </a>
                </li>
                <li>
                    <a href="Practica4/" class="block bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg p-4 text-blue-950">
